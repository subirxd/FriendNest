            ...
            <div className='bg-white rounded-lg shadow p-6'>
                ...
                <form className='space-y-4' onSubmit={handleSaveProfile}>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        <label htmlFor='profile_picture' className='block text-sm font-medium text-gray-700 mb-1'>
                            ...
                            <input id='profile_picture' type='file' accept='image/*' 
                                className=' hidden w-full p-3 border border-gray-200 rounded-lg'
                            ...
                            <div className='group/profile relative'>
                                ...
                                <div className='absolute hidden group-hover/profile:flex top-0 right-0
                                bottom-0 left-0 bg-black/20 rounded-full items-center justify-center'>
                    ...
                    <div className='flex flex-col items-start gap-3'>
                        ...
                        htmlFor='cover_photo'>
                            Cover photo
                            <input id='cover_photo' type='file' accept='image/*' 
                                className=' hidden w-full p-3 border border-gray-200 rounded-lg'
                            ...
                            <div className='group/cover relative'>
                                ...
                                alt='userCoverPhoto' 
                                className='w-80 h-40 rounded-lg bg-gradient-to-r from-indigo-200 via-purple-200
                                to-pink-200 object-cover mt-2' />

                                <div className='absolute hidden group-hover/cover:flex top-0 left-0 right-0
                    ...
                    <div className='flex justify-end space-x-3 pt-6'>
                        <button type='button' className='px-4 py-2 border border-gray-300 rounded-lg text-gray-700 
